...
//   result += node.value
//   node.children.every( children => {result += children.value})
// }
...
// const string = "| Card 1: Yes | Card 2: Yes | Card 3: Yes | Card 4: Yes | Card 5: No | Card 6: Yes |"

// console.log(string.split( ' | '))


/*
Допишите код вместо XXX, YYY, ZZZ, NNN, MMM, LLL для вычисления суммы квадратов нечетных чисел из массива 'numbers', с использованием методов массива.
В качестве ответа дайте пропущенный код через пробел или с новой строки.
